...
NOT_SUBSCRIBED_TEXT = "❌ <b>Вы ещё не подписались на канал!</b>\nСначала подпишитесь, потом нажмите «✅ Проверить подписку»"
PARTICIPATE_TEXT = "✅ <b>Теперь вы участвуете в конкурсе!</b>\nРезультаты будут в канале 5 апреля."
ALREADY_PARTICIPATE_TEXT = "⚠️ <b>Вы уже участвуете в конкурсе!</b>\nЖдите результатов 5 апреля."
